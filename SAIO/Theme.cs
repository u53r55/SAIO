...
static internal class Helpers
{
    ...
    {
        if (SAIO.Properties.Settings.Default.IconColor == Color.Black)
        {
            if (i == 0)
            {
                return SAIO.Properties.Resources.Tab1_Proxies_Black;
            }
            else if (i == 1)
            {
                return SAIO.Properties.Resources.Tab2_Lists_Black;
            }
            else if (i == 2)
            {
                return SAIO.Properties.Resources.Tab3_Encryption_Black;
            }
            else
            {
                return SAIO.Properties.Resources.x1_Settings_Black;
            }
        }
        else
        {
            if (i == 0)
            {
                return SAIO.Properties.Resources.Tab1_Proxies;
            }
            else if (i == 1)
            {
                return SAIO.Properties.Resources.Tab2_Lists;
            }
            else if (i == 2)
            {
                return SAIO.Properties.Resources.Tab3_Encryption;
            }
            else
            {
                return SAIO.Properties.Resources.x1_Settings;
            }
        }
    }
    #endregion
    ...
    class MaterialButton : Button
    {
        ...
        public MaterialButton()
        {
            ...
            if (ReferenceEquals(Tag, "Alert"))
                BackColor = Properties.Settings.Default.AlertColor;
            else
        ...
        protected override void OnMouseUp(MouseEventArgs e)
        {
            ...
            {
                if (ReferenceEquals(Tag, "Alert"))
                    BackColor = Color.FromArgb(230, Properties.Settings.Default.AlertColor);
                else
                    BackColor = Color.FromArgb(230, Properties.Settings.Default.HighlightColor);
            }
        }
        #endregion
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            G.DrawString(Text, Font, new SolidBrush(ForeColor), DisplayRectangle, sf);
